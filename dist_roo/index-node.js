...
// ../../packages/directive/node_modules/markdown-it-directive/index.js
var require_markdown_it_directive = __commonJS({
  "../../packages/directive/node_modules/markdown-it-directive/index.js"(exports2, module2) {
    "use strict";
    ...
    var DIRECTIVE_NAME_RE = /^[a-z][a-z0-9\-_]*/i;
    var normalizeDirectiveName = (s) => s.toLowerCase().replace("_", "-");
    ...
    function parseLinkDestinationLabel(md, src, pos, max) {
      ...
      if (src.charCodeAt(pos) !== 40) return null;
      const dests = [];
      ...
      for (; pos < max; pos = skipBlanks(src, pos, max)) {
        ...
        if (!isBlank(charBetween) && charBetween !== 41) return null;
      }
      return null;
    }
    ...
    function parseAttrLabel(md, src, pos, max) {
      ...
      for (; pos < max; pos = skipBlanks(src, pos, max)) {
        ...
        if (c === 35) {
          ...
          if (pos >= max) return null;
          if (src.charCodeAt(pos) !== 61) return null;
          ++pos, pos = skipBlanks(src, pos, max);
          if (pos >= max) return null;
          let value;
        ...
        if (pos >= max) return null;
        const charBetween = src.charCodeAt(pos);
        if (!isBlank(charBetween) && charBetween !== 125) return null;
      }
      return null;
    }
    function parseDirective(state, src, pos, max, allowSpaceBetween) {
      ...
      const labelStart = pos, labelEnd = md.helpers.parseLinkLabel(state, labelStart);
      let content;
    ...
    function inlineDirectiveRule(state, silent) {
      ...
      let pos = state.pos;
      if (src.charCodeAt(pos) !== 58) return false;
      ++pos;
    ...
    function findNextLine(src, startLine, endLine, state) {
      ...
      for (; line < endLine && level !== 0; ++line) {
        ...
        let pos2 = state.skipChars(pos, 58);
    ...
    function blockDirectiveRule(state, startLine, endLine, silent) {
      ...
      if (pos + 3 > max || src.charCodeAt(pos) !== 58 || src.charCodeAt(pos + 1) !== 58) {
        return false;
      }
      pos += 2;
      let oneLine = false;
      ...
      let tmp = state.skipCharsBack(posEnd, 58, pos);
...
// ../../packages/directive/build/index.js
var require_build = __commonJS({
  "../../packages/directive/build/index.js"(exports2, module2) {
    "use strict";
    ...
    __export2(src_exports, {
      ...
      directiveParser: () => directiveParser2,
      ...
      registerContainerDirective: () => registerContainerDirective2,
    ...
    var import_markdown_it_directive = __toESM2(require_markdown_it_directive());
    var RULE = {
    ...
    function registerContainerDirective2(md, nameOrConfig, maybeHandler) {
    ...
    function applyTokenFields(token, { attrs, meta }, params) {
      if (attrs !== void 0) {
        const value = isFunction(attrs) ? attrs(params) : attrs;
        token.attrs = Object.entries(value);
      }
      if (meta !== void 0) {
        const value = isFunction(meta) ? meta(params) : meta;
        token.meta = value;
      }
    }
    var directiveParser2 = () => {
      return (md) => {
...
// src_roo/plugin/index-node_roo.ts
var index_node_roo_exports = {};
__export(index_node_roo_exports, {
  transform: () => transform
});
module.exports = __toCommonJS(index_node_roo_exports);

// src_roo/renderer/server_roo.tsx
var React = __toESM(require("react"));
var import_server = require("react-dom/server");

// src_roo/runtime/index_roo.tsx
var ReactServer = __toESM(require("react"));
function getReact() {
  if (typeof window === "undefined") {
    return ReactServer;
  }
  return typeof window !== "undefined" && window.React ? window.React : ReactServer;
}
var componentRegistry = {};
function registerComponent(name, component) {
  componentRegistry[name] = component;
}
function createReactComponentElement(data, isServer) {
  const React2 = getReact();
  ...
  return React2.createElement(
    ...
    children.map(
      (child, index) => typeof child === "object" && child.component ? createReactComponentElement(child, isServer) : child
    )
  );
}
...
var Counter = (props) => {
  ...
  const counterRef = React2.createRef();
  const updateDisplay = () => {
  ...
  return React2.createElement(
    ...
    [
      React2.createElement("h3", { key: "title" }, "Counter Component"),
      React2.createElement("p", { key: "count" }, [
        "Count: ",
        React2.createElement("span", { key: "value", ref: counterRef }, count)
      ]),
      React2.createElement("div", { key: "buttons", style: { display: "flex", gap: "10px" } }, [
...
// src_roo/plugin/const_roo.ts
var ENV_FLAG_NAME = "has-react-component";
var TokenType = {
  ReactComponent: "react_component",
  ReactComponentOpen: "react_component_open",
  ReactComponentClose: "react_component_close"
};
var ClassNames = {
  ReactComponent: "react-component",
  ReactComponentContainer: "react-component-container"
};

// src_roo/renderer/server_roo.tsx
global.React = React;
function createReactComponentContent(componentData) {
  try {
...
// src_roo/renderer/factory_roo.ts
var currentImplementation = null;
function setReactComponentImplementation(implementation) {
  currentImplementation = implementation;
}
function getReactComponentContent(componentData) {
...
// src_roo/plugin/directive_roo.ts
var import_directive = __toESM(require_build());
var reactComponentDirective = (md) => {
...
// src_roo/plugin/transform_roo.ts
